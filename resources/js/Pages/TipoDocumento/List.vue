...
onMounted(() => {
  datas.list = props.tipodocumentos
})
...
<template>
  ...
  <div v-else>
    <div v-if="datas.list.length != 0 && !datas.isLoad" class="p-8">
      <div class="relative overflow-x-auto">
        ...
        >
          ...
          <tbody>
            <tr
              v-for="tipodocumento in datas.list"
            ...
            >
              ...
              <td class="px-6 py-4">
                {{
                  tipodocumento.created_at != null
                    ? fecha(tipodocumento.created_at)
                    : ''
                }}
              </td>
              <td class="px-6 py-4">
              ...
              <td class="px-6 py-4">
                <Link
                  :href="route('tipodocumento.edit', tipodocumento.id)"
