...
const queryDocument = async (consulta) => {
  ...
  await axios
    .post(url)
    .then((response) => {
      react.list_typedocument = response.data.data
    })
    .catch((error) => {
  ...
  await axios
    ...
    .then((response) => {
      ...
      if (response.data.success) {
        react.list_habitante = response.data.data
      } else {
        react.list_habitante = []
      }
    })
    .catch((error) => {
      console.log('respuesta error')
...
const queryVivienda = async (consulta) => {
  ...
  await axios
    .post(url)
    .then((response) => {
      react.list_vivienda = response.data.data
    })
    .catch((error) => {
      console.log('respuesta error')
      console.log(error)
    ...
    <div class="max-w-7xl py-6 mx-auto sm:px-6 lg:px-8">
      <FormSection @submitted="createInformacion">
        ...
        <template #form>
          ...
          <div v-else class="w-full" style="width: 100% !important;">
            <!-- Name -->
              ...
              <div class="flex">
                ...
                <div class="relative w-full">
                  <input
                    ...
                    placeholder="Consulta habitantes"
                    required
                  />
                  <button
                    type="submit"
